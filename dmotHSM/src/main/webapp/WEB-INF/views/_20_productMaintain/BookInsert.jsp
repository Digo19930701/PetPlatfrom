...
<!-- 而且method屬性必須是 "post" -->
<form:form  id="form1" modelAttribute='bookBean' method="post"  enctype="multipart/form-data" >
...
<table  class="table_color" border="1" >
   <tr height='40'>
    ...
    <tr height='42'>
       <td width="60" align="right" class="title_font">書名</td>
       <td colspan="3"> 
