  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-row style="width: 100%; min-width: 1024px">
        <el-col v-for="service in serviceData" :span="8" >
          <el-card :body-style="{ padding: '0px' }">
            <el-image class="sellerImg" :src="service.serviceImage1" fit="cover">
            </el-image>
            <!-- <img
            ...
            <div style="padding: 14px">
              ...
              <span>
                ...
                {{ service.availTime1 }} ~ {{ service.availTime2 }}
                <!-- {{ service.category }} -->
              </span>
              <div class="bottom">
                <router-link to="/good">
...
const adUrl = [
  ...
  'https://images.pexels.com/photos/96428/pexels-photo-96428.jpeg?auto=compress&cs=tinysrgb&w=1600'
]
const sellers = [
  {
    sellerImg:
