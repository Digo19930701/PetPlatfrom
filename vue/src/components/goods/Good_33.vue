  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18461393/pexels-photo-18461393.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                Our Season 有細心能力照顧狗狗。 　　
                （能夠清理狗狗便溺、身體基本清潔（助理美容師需小美容） 願意陪狗狗互動及遊戲。
                （每隻狗狗個性不同，需有愛心、耐心觀察，親近，並且陪伴）
                對狗狗吠叫或愛咬有基本認識。
                （不會對狗狗吠叫感到厭煩，能瞭解吠叫原因並以適度方法做應對，能初步判斷狗狗是否親人進而接近照顧）
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                近年來臺灣隨著人口結構和生活型態的改變，及人際關係疏離與情感關係重整、少子化、老年化等因素影響下，興起一股寵物飼養風潮，臺灣的寵物店、寵物美容與動物醫院家數也逐年增加。
              </span>
            </el-card>
          </el-space>
          <br />
...
const good_title = '[Our Season]寵物照顧'
