  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/736530/pexels-photo-736530.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                Fight寵物沙龍是一家致力於提供高品質寵物美容和護理服務的專業沙龍。我們的團隊由經驗豐富的寵物美容師組成，他們充滿愛心，對每隻寵物的福祉充滿關愛。我們提供一個舒適、安全且衛生的環境，以確保您的寵物得到最佳的照顧和美容服務。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                每週日至週三皆可預約貓咪狗狗洗澡，週四至週六則為貓咪專屬時間。美容作業方式為全程一對一服務，美容師同時擁有寵物美容師和貓美容師雙證照，若同時養狗又養貓的家長們也可以一次將寶貝們送去美容。服務項目包含寵物洗澡、寵物美容剪毛、深層潔淨奈米浴、全身去油和各式加值服務。
              </span>
            </el-card>
          </el-space>
          <br />
          <el-card class="storeC">
            ...
            <span>
              <div>
                ...
                <h2>規格</h2>
                <el-button round size="large" class="plan-bn" @click="money(800)"> 洗澡</el-button>
                <el-button round size="large" class="plan-bn" @click="money(1500)"
                  >大美容</el-button
                >
                <el-button round size="large" class="plan-bn" @click="money(1500)"
                  >SPA 碳酸泉水療浴</el-button
                >
                <el-divider />
                <div>
