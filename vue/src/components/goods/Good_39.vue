  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18443045/pexels-photo-18443045.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Smile
                寵物照顧是一項負責任的工作，需要確保您的寵物在身體和心理上都得到良好的照顧。這將幫助您的寵物享有快樂、健康和充實的生活。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                緊急情況的應對： <br />準備應對緊急情況，如自然災害或突發疾病。
                知道獸醫和寵物急救設施的位置。
              </span>
            </el-card>
          </el-space>
