  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18456000/pexels-photo-18456000.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Ditto
                寵物生活館是一家專業的寵物生活服務提供商，我們致力於提供全面的寵物護理、美容和娛樂服務，讓您的寵物擁有健康、快樂和充實的生活。我們的團隊熱愛寵物，對寵物的福祉充滿關愛，並致力於提供最優質的服務。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                寵物照顧： <br />我們提供家居寵物照顧服務，包括餵食、散步、清潔、陪伴等。<br />
                如果您需要長期照顧或特殊需求的照顧，我們也可以提供。 <br /><br />
                寵物娛樂：<br />
                我們設有寵物遊樂場，提供安全和有趣的環境，讓您的寵物可以與其他寵物互動、玩耍和運動。
                我們也提供寵物活動和社交聚會，讓您的寵物可以擴展社交圈。
              </span>
            </el-card>
          </el-space>
          <br />
