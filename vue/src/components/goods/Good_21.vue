  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/688835/pexels-photo-688835.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                SPECIALZ工作室是一家專業的寵物攝影工作室，我們致力於捕捉您的寵物最美麗的瞬間，創造永恆的回憶。我們的攝影師具有豐富的經驗，充滿愛心，能夠與各種寵物建立連接，創造出精美的寵物攝影作品。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                我們的攝影師將與您一起討論您的寵物攝影需求，包括風格、場景、主題等。
                我們將嘗試了解您的寵物，以確保攝影作品反映出他們的個性和特點。<br /><br />
                攝影拍攝：<br />

                我們提供專業的攝影拍攝，可以在工作室內或戶外進行，根據您的喜好和需求選擇場地和風格。
                我們的攝影師將努力捕捉您寵物的最佳瞬間，以獲得精美的攝影作品。<br /><br />
                編輯和後期處理：<br />

                我們將對攝影作品進行精心的編輯和後期處理，以確保圖片的質量和美觀。
                您將獲得高質量的數字圖片，以便在印刷品、相冊或社交媒體上分享。
              </span>
            </el-card>
          </el-space>
          <br />
...
const good_title = '[SPECIALZ]寵物攝影'
