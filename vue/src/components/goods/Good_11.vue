        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Haru
                寵物溝通是一家專業的寵物溝通服務提供商，我們的使命是幫助人們更深入地了解和連接他們的寵物。我們的寵物溝通師具有豐富的經驗，能夠透過心靈感應和溝通技巧，聆聽並理解寵物的需求、情感和訊息，並將這些訊息傳達給寵物的主人。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                透過直接的心靈感應和寵物的能量場，我們的寵物溝通師可以與您的寵物進行溝通。
                我們會詢問寵物關於他們的感受、需求、喜好和情緒的問題，並傳達這些信息給您。
                <br /><br />問題解決：<br />

                如果您的寵物有行為問題、健康問題或其他困擾，我們的寵物溝通師可以試圖找出根本原因，以便改善情況。
                我們可以提供建議，以幫助您更好地滿足您的寵物的需求。<br /><br />
                連接和溝通：<br />

                Haru 寵物溝通的目標是建立更深層次的連接，幫助您更好地理解您的寵物。
                我們的服務有助於增進您和寵物之間的信任和情感連接。
              </span>
            </el-card>
          </el-space>
          <br />
