        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                What工作室拍攝環境被網友稱讚舒適得就像在家一般自在，且攝影師親切有耐心，不只會給予專業的動作指導、不讓毛小孩太累，更是非常懂得毛孩的習性，會及時舒緩牠們的情緒。建議有興趣的大家，盡可能要提早預約拍攝！
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                提供韓式證件照、兒童寫真、全家福、情侶照、閨蜜寫真和寵物證件照等各式攝影服務，優點是能馬上為客人調整，以及快速取件。然而需要注意的是，工作室拍攝時皆會使用閃光燈，且拍攝時會在較高的桌面上拍攝，若毛孩怕高或是會從高處跳下的話，比較不建議拍攝，就請飼主們斟酌啦。
              </span>
            </el-card>
          </el-space>
          <br />
