  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/169524/pexels-photo-169524.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                The Scientist
                寵物美容是一家專業的寵物美容沙龍，我們致力於提供高品質的護理和美容服務，以確保您的寵物看起來和感覺最好。我們的團隊由經驗豐富、富有愛心的寵物美容師組成，他們充分了解寵物的需求，將寵物的福祉視為首要任務。
              </span>
            </el-card>
            <br />
...
const good_title = '[The Scientist]寵物美容'
