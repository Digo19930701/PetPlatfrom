  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/65006/pexels-photo-65006.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            ...
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                我們提供各種寵物美容服務，包括洗澡、修剪、造型、指甲修剪、耳朵清潔等。
                我們的美容師會根據您的寵物的需求和您的要求，為他們提供專業的美容服務。<br /><br />
              </span>
            </el-card>
          </el-space>
          <br />
...
const good_title = '[Pour Up]寵物洗澡和美容'
