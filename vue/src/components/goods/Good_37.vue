  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18444764/pexels-photo-18444764.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                Maps 定期運動： 讓寵物得到足夠的運動，以保持健康的體重和身體狀態。
                散步、跑步、玩球等活動有助於寵物消耗能量並提供精神刺激。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                醫療保健： <br />定期帶寵物去看獸醫進行例行檢查和疫苗接種。
                處理任何健康問題，如感染、寄生蟲、皮膚問題等。
              </span>
            </el-card>
          </el-space>
          <br />
