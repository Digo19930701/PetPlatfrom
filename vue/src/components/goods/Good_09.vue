        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                Love Phobia寵物明亮乾淨的美容室，清楚看見毛孩的美容狀況
                使用檢驗認證洗劑，毛孩洗澡更安心！ 多元化的寵物美容服務，都在Love Phobia寵物
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                基礎美容<br />
                剪指甲、剃毛(腳底.腹部.屁屁) 有助於寵物正常行走、散熱
                洗澡前梳毛，幫助寵物去除打結及廢毛，帶走毛髮中的汙垢 <br /><br />洗澡/SPA護膚<br />
                洗澡連同耳朵、口腔、肛門腺一起清潔，小細節也要100分用心
                SPA護膚使用GMP認證天然草本泥，提供皮膚營養，增加免疫力 <br /><br />剪毛/純手剪<br />
                剪毛時會進行整體細修，加強頭部、四肢、尾巴部位修剪
                若想幫毛孩做出可愛的造型，可加購純手剪服務，進行造型修剪
              </span>
            </el-card>
          </el-space>
          <br />
...
const good_title = '[Love Phobia]美容/洗澡/SPA'
