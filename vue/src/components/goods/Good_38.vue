  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18444792/pexels-photo-18444792.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                kataomoi 社交和情感照顧： 給予寵物足夠的關愛、關注和陪伴時間。
                建立良好的互動關係，了解寵物的需求和情感狀態。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                訓練和教育： <br />提供基本的訓練，幫助寵物適應家庭生活和社會環境。
                培養良好的行為和禮貌。
              </span>
            </el-card>
          </el-space>
...
const good_title = '[kataomoi]寵物照顧'
