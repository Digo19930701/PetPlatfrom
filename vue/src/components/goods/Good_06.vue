  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/14084426/pexels-photo-14084426.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                綠茵小筑寵物精品沙龍是一家專業的寵物美容和護理服務提供商，我們致力於提供高品質的護理和美容服務，以確保您的寵物看起來和感覺最好。我們的團隊由經驗豐富、富有愛心的寵物美容師組成，他們充分了解寵物的需求，將寵物的福祉視為首要任務。
              </span>
            </el-card>
            <br />
