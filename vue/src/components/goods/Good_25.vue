        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Good
                Time工作室為毛小孩打造各式風格攝影，無論是文青風簡單素背照，還是有趣可愛爆破系列、夢幻寵物造型場景還是獨家自然採光空中花園，工作室有多達40種以上的主題場景，不僅有引逗師從旁引導，且攝影師還會適時讓毛孩休息並適應環境，相當專業。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                提供多種寵物寫真方案，其中不少方案飼主也可以入鏡拍攝，重點是攝影師善於呈現出毛孩搗蛋的眼神和俏皮的舉動，而即使是在毛小孩不受控的情況下，也能迅速找到角度拍攝。攝狗狗寵物寫真工坊有上百種裝扮，還有多樣的造景組合，能為狗狗貓貓們創造專屬的場景氛圍，所以很多飼主來訪拍攝過一次之後，便決定要再二訪呢！
              </span>
            </el-card>
          </el-space>
          <br />
...
const good_title = '[Good Time]寵物攝影'
