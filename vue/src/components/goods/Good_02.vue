  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/1436139/pexels-photo-1436139.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                kokuhaku寵物精緻沙龍是一家專業的寵物美容和護理服務提供商，我們致力於為您的寵物提供高品質的護理和美容服務，以確保他們看起來和感覺最好。我們的團隊由經驗豐富的寵物美容師和愛心的護理人員組成，他們對每隻寵物的福祉充滿熱情。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                根據您的寵物的需要和您的要求，我們可以提供個性化的美容服務。<br /><br />
                皮膚和毛髮護理：
                <br />
            ...
            <span>
              <div>
                ...
                <el-button round size="large" class="plan-bn" @click="money(1800)"
                  >皮膚和毛髮護理</el-button
                >
                <el-button round size="large" class="plan-bn" @click="money(2700)"
                  >寵物SPA和按摩</el-button
                >
                <el-divider />
                <div>
...
const good_title = '[kokuhaku]寵物洗澡和美容'
