        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Tsugeru
                寵物溝通動物溝通(第六感溝通)係透過第六感知覺接收或自發性感覺到動物的影像、聲音、氣味、情緒或觸覺等等。少數動物溝通人員會透過聖壇、水晶、魔法、宗教儀軌、靈界、動物指導靈、大地或萬有之靈等方式輔助溝通的過程，此部分稱為「間接溝通」，雖然與一般動物溝通相似，但有所相異，較偏向靈性、靈媒的動物溝通模式。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                一、為現場溝通 (與動物和飼主一同見面)。<br />
                二、為現場遠距溝通 (僅與飼主見面，無須與動物見面) 。<br />
                三、是線上遠距溝通 (無須與飼主或動物見面)。<br />

                多數第六感動物溝通師溝通方式為線上遠距溝通，僅需事先提供二至三張近照，在約定時間內，與動物溝通線上諮詢即可。
              </span>
            </el-card>
          </el-space>
          <br />
