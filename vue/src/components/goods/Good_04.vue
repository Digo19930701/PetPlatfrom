        ...
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                D寵物精緻沙龍是一家專業的寵物美容和護理服務提供商，我們致力於為您的寵物提供高品質的護理和美容服務，讓他們看起來和感覺最好。我們的團隊由經驗豐富的寵物美容師組成，他們熱愛寵物，對每隻寵物的福祉充滿熱情，並致力於提供最優質的服務。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                我們提供各種寵物美容服務，包括洗澡、修剪、造型、指甲修剪、耳朵清潔等。<br />
                我們的美容師會根據您的寵物的需求和您的要求，為他們提供專業的美容服務。<br /><br />
                皮膚和毛髮護理：<br />

                我們使用高品質的洗髮精、護毛素和其他護理產品，以確保寵物的皮膚和毛髮保持健康和光澤。
                如果您的寵物有皮膚問題，我們也提供相關的皮膚護理服務。<br /><br />
                寵物SPA和按摩：<br />

                我們提供寵物SPA服務，包括按摩，有助於促進寵物的血液循環和放鬆肌肉。<br />
                這些服務有助於提高寵物的整體幸福感。
              </span>
            </el-card>
          </el-space>
