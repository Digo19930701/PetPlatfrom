  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18452883/pexels-photo-18452883.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Baby
                美式寵物保姆訓練寵物保姆、美容師、遛狗師都得滿分通過線上訓練課程和測驗，測試保姆的專業度、服務精神、愛動物絕對是必須的！確保服務品質，用戶不滿意可全額退費。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                預訂服務全程攝影安心回報，毛爸媽在外隨時收到毛孩各種狀況。服務前提供免費家訪透過事先家訪，讓毛孩與保姆先有第一次接觸，建立信任感，且服務期間全程含國泰保險(最高200萬理賠)與服務不滿意全額退款保障。
              </span>
            </el-card>
          </el-space>
          <br />
