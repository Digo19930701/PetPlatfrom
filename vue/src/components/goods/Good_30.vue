  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/5264088/pexels-photo-5264088.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              <h2>商家簡介</h2>
              <span class="inf">
                Feather寵物保母是一家專業的寵物照顧服務提供商，我們致力於為您的寵物提供高品質的照顧和關愛，無論您是外出度假、工作或其他原因需要照顧寵物，我們都在這裡為您提供可信賴的服務。我們的團隊擁有豐富的經驗，熱愛寵物，並將寵物的福祉置於首位。
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              ...
              <span class="int">
                ...
                我們的專業保母會到您的家中，照顧您的寵物，包括餵食、清潔、陪伴、散步等。<br />
                這可以減少寵物的壓力，因為他們可以在自己熟悉的環境中得到照顧。<br /><br />
                遛狗服務：<br />

                如果您需要幫助遛狗，我們的保母可以每天定期來您家，遛您的狗，確保他們得到足夠的運動和戶外活動。<br /><br />
                寵物陪伴：<br />

                我們的保母可以花時間與您的寵物互動，提供陪伴、玩耍和撫摸。<br />
                這對於寵物的情感和幸福感非常重要。
              </span>
            </el-card>
          </el-space>
          ...
          <el-card class="storeC">
            ...
            <span>
              <div>
                ...
                <h2>規格</h2>
                <el-button round size="large" class="plan-bn" @click="money(600)"
                  >家居寵物照顧</el-button
                >
                <el-button round size="large" class="plan-bn" @click="money(450)"
                  >遛狗服務</el-button
                >
                <el-button round size="large" class="plan-bn" @click="money(600)"
                  >寵物陪伴</el-button
