  ...
  <el-container>
    <el-main>
      ...
      >
        ...
        <div class="goodPic">
          <img
            src="https://images.pexels.com/photos/18452316/pexels-photo-18452316.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            class="picImg"
          />
        </div>
        <div class="store">
          ...
          <el-space class="storeSpace" direction="vertical">
            <el-card class="storeInf">
              ...
              <span class="inf">
                Reloaded
                寵物照顧是關心和照顧您的寵物，確保它們的生活質量、健康和幸福的過程。以下是一些寵物照顧的重要方面
              </span>
            </el-card>
            <br />
            <el-card class="storeIntro">
              <h2>服務介紹</h2>
              <span class="int">
                飲食照顧： <br />提供適當的食物和飲水，確保寵物獲得足夠的營養。
                選擇合適的食物品牌和種類，以滿足寵物的特殊需求，如幼犬或老年寵物。
                定期餵食，遵循建議的食量和食物時間表。
              </span>
            </el-card>
          </el-space>
...
const good_title = '[Reloaded]寵物照顧'
