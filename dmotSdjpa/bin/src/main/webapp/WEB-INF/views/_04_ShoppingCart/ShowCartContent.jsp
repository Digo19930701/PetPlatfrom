   ...
   <td>
     ...
     <c:forEach varStatus="vs" var="anEntry" items="${ShoppingCart.content}">
        <tr height='16'>
          ...
          <td style="text-align:center;">${fn:substring(anEntry.value.publisherName, 0, 2)}</td>
   ...
   <td > 
     <table border='1'>
        <tr >
          ...
          <td width="265" align='center'>
              <a href="<c:url value='/_04_ShoppingCart/checkout' />" onClick="return Checkout(${subtotal});">完成購物</a>
          </td>
          <td width="265" align='center'>
              <a href="<c:url value='/_04_ShoppingCart/abort' />" onClick="return Abort();">放棄購物</a>
          </td>
        </tr>
     </table>
   </td>
