...
import com.ispan.eeit._02_login.model.LoginBean;
import com.ispan.eeit._02_login.validator.LoginBeanValidator;
...
public class LoginController02 {
	...
	private static Logger log = LoggerFactory.getLogger(LoginController02.class);
	...
	@Autowired
	public LoginController02(MemberService memberService) {
	...
	public String checkAccount(
		...
		try {
			...
			member = memberService.findByMemberIdAndPassword(bean.getUserId(),  
					               password);
			if (member != null) {
